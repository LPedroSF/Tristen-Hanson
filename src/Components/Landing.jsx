...
function Landing() {
  return (
    <div className='landing'>
      ...
      <p className='landing__subtitle'>I'm an <span className='purple'> artistic graphic designer</span> with a passion for digital art and creating visual graphics.</p>
